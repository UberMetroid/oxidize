...
pub static MOON_DATA: &[&[(&str, f64, f64, &str)]] = &[
    &[], // Mercury - no moons
    &[], // Venus - no moons
    &[("Luna", 1.5, 2.0, "#c0c0c0")], // Earth - Luna
    &[("Phobos", 1.0, 1.5, "#8b7355"), ("Deimos", 0.8, 1.0, "#a0522d")], // Mars
    &[("Io", 1.2, 1.8, "#ffff00"), ("Europa", 1.0, 1.5, "#f5deb3"), ("Ganymede", 1.5, 2.0, "#808080"), ("Callisto", 1.2, 1.8, "#4a4a4a")], // Jupiter - Galilean moons
    &[("Titan", 2.0, 2.0, "#d4a574"), ("Enceladus", 0.8, 1.0, "#f0f0f0"), ("Mimas", 0.7, 0.8, "#c0c0c0"), ("Rhea", 1.0, 1.2, "#d3d3d3")], // Saturn
    &[("Titania", 1.2, 1.2, "#808080"), ("Oberon", 1.0, 1.0, "#696969")], // Uranus
    &[("Triton", 1.5, 1.5, "#87ceeb")], // Neptune - Triton
];
#[allow(dead_code)]
